...
SIP feed, ~3 GB total). The working copy of the data AND of these scripts lives
in `data/research/night/` (daily-book research) and `data/research/swing/`
(swing harness), gitignored; run scripts from there. Paths are absolute to this
checkout. RESULTS.md addendum 14 lists the data errors found in this set.
...
| fetch_late.py | 15:30-16:00 1-min bars for every stock whose day LOW was <= -8% (was: close <= -6%, a lookahead; addendum 14) |
